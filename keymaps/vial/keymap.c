...
#define SW1_PIN GP11
#define SW2_PIN GP10
#define SWAP_FN_PIN GP13
#define SWAP_FN2_PIN GP12
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_default] = LAYOUT(
         ...
         LT(1,KC_ENT), LT(2,KC_SPC),   LGUI_T(KC_TAB), KC_NO,	 KC_NO
     ),
     [_lo] = LAYOUT(

         KC_1,         KC_2,           KC_3,           KC_4,     KC_5,	   KC_F12,
         KC_Y,         KC_U,           KC_I,           KC_O,     KC_P,     KC_BSPC,
         KC_H,         KC_J,           KC_K,           KC_L,     KC_SCLN,  KC_QUOT,
         KC_N,         KC_M,           KC_COMM,        KC_DOT,   KC_SLSH,  KC_RSFT,
         LT(1,KC_ENT), LT(2,KC_SPC),   LGUI_T(KC_TAB), KC_NO,	 KC_NO
...
if (swap_fn_on && swap_fn2_on) {
    switch (keycode) {
        ...
        case KC_I: tap_code(KC_UP); return false;
        case KC_J: tap_code(KC_LEFT); return false;
        case KC_K: tap_code(KC_DOWN); return false;
        case KC_L: tap_code(KC_RIGHT); return false;
    ...
    switch (keycode) {
        ...
        case KC_6: tap_code(KC_1); return false;
        case KC_7: tap_code(KC_2); return false;
        case KC_8: tap_code(KC_3); return false;
        case KC_9: tap_code(KC_4); return false;
        case KC_0: tap_code(KC_5); return false;

        case KC_F6: tap_code(KC_F1); return false;
        case KC_F7: tap_code(KC_F2); return false;
        case KC_F8: tap_code(KC_F3); return false;
        case KC_F9: tap_code(KC_F4); return false;
        case KC_F10: tap_code(KC_F5); return false;
     ...
     switch (get_highest_layer(layer_state)) {
        ...
        case _lo:
             for (int i = 0; i <= 1; i++) {
                     ...
                     rgb_matrix_set_color(0, 255 * BRIGHT1, 128 * BRIGHT1, 192 * BRIGHT1 );
                     rgb_matrix_set_color(1, 255 * BRIGHT1, 128 * BRIGHT1, 192 * BRIGHT1 );
